function BSC_LSS_FIR(stat_path,sots_path,exp_folder,N,TR,model,q_level,ground_truth)
...
dur = (length(dir([stat_path filesep exp_folder filesep 'funct_images_after_FIR_task_regression'])) - 2)/N;
...
for subji = 1:N
    ...
    save([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'BSC_LSS_FIR.mat'],'BSC*','betas_LSS');
    clear BSC* betas_LSS
...
for subji = 1:N
    load([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'BSC_LSS_FIR.mat']);
...
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'BSC_LSS_FIR.mat'],'BSC*');
time = toc;
...
%% Save results
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'BSC_LSS_FIR_RESULTS.mat'],'TPR*','TNR*');